                ...
                <v-col cols="auto">
                    <v-menu v-model="menu" :close-on-content-click="false" :nudge-right="40" transition="scale-transition"
                        ...
                        <v-date-picker v-model="dates" range>
                            <v-spacer></v-spacer>
                            <v-btn text color="primary" @click="limpiarFiltro">
                                Cancelar
                            </v-btn>
                            <v-btn text color="primary" @click="filtrarPorFecha">
                                Filtrar
                            </v-btn>
                        </v-date-picker>
                    </v-menu>
                        ...
                        <v-card-text>
                            ...
                            <v-row dense>
                                ...
                                <v-col cols="12" sm="12">
                                    <v-combobox v-model="correos_alerta" :items="tarea.correos_alerta" hide-selected
                                        hint="Ingrese una o varias direcciones de correo y presione Enter o TAB "
                                        label="Direcciones de correo para recibir las alertas" multiple persistent-hint
                                        small-chips deletable-chips :delimiters="[';']" @change="delimitCorreos">
                                    </v-combobox>
                                </v-col>
                                <v-col cols="12">
                                ...
                                <v-col cols="12" sm="12">
                                    ...
                                    <v-btn color="success" block v-if="files.length > 0" @click="subirArchivos"
