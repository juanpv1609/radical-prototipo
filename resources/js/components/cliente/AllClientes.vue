<template>
    <div>
        <v-card elevation="2" :loading="loading">
            <v-card-title>
                <v-badge :content="clientes.length" :value="clientes.length" color="green">
                    Clientes
                </v-badge>
                <v-spacer></v-spacer>
                <v-col cols="auto">
                ...
                <v-btn class="mx-2" fab dark small color="primary" :disabled="$store.state.user.role == 1" @click="addClient">
                    <v-icon dark>
                        mdi-plus
                    </v-icon>
                </v-btn>
                ...
                <v-data-table :headers="headers" :items="clientes" :search="search">
                    <template v-slot:item="row">
                        <tr>
                            ...
                            <td>
                                <v-btn icon color="primary" :disabled="$store.state.user.role == 1"
                                    @click="editClient(row.item)">
                                    <v-icon dark>mdi-pencil</v-icon>
                                </v-btn>
                                <v-btn icon color="error" :disabled="$store.state.user.role == 1"
                                    @click="deleteClient(row.item)">
                    ...
                    <v-card>
                        ...
                        <v-card-text>
                            <v-container>
                                <v-row>
                                    <v-col cols="6">
                                        <v-select :items="tipo_identificacion" v-model="cliente.tipo_identificacion"
                                    ...
                                    <v-col cols="6">
                                        <v-text-field v-model="cliente.dni" label="Numero de identificacion*"
                                            required></v-text-field>
                                    </v-col>
                                </v-row>
                                <v-row>
                                    <v-col cols="6">
                                        <v-text-field v-model="cliente.razon_social" label="Razon social*"
                                            required></v-text-field>
                                    </v-col>
                                    <v-col cols="6">
                                ...
                                <v-row>
                                    <v-col cols="6">
                                        <v-text-field v-model="cliente.correo" label="Correo electronico"
                                            required></v-text-field>
                                    </v-col>
                                    <v-col cols="6">
                                        <v-text-field v-model="cliente.telefono" label="Telefono"></v-text-field>
                                    </v-col>
                                </v-row>
                                <v-row>
                                    <v-col cols="6">
                        ...
                        <v-card-actions>
                            ...
                            <v-btn v-if="!update" color="primary" text @click="createClient">
                                Guardar
                            </v-btn>
                            <v-btn v-else color="primary" text @click="updateClient">
                                Actualizar
                            </v-btn>
                        </v-card-actions>
                    </v-card>
