...
{
    // ! Credenciales de acceso a la API ( Se puede poner en la base de Datos )
    ...
    public function addMailToCategories()
    {
        ...
        // ! destinatarios por categoría, escalar a la base de datos
        $destinatarios = [
            'SIEM' => 'juan.perugachi@gruporadical.com,brenda.perez@gruporadical.com,maylee.pineda@gruporadical.com',
            'Análisis de Vulnerabilidades Web' => 'lenin.cortes@gruporadical.com',
            'Web Application Firewall' => 'richard.teran@gruporadical.com',
            'Firewall' => 'washington.cardenas@gruporadical.com,gabriel.luna@gruporadical.com',
