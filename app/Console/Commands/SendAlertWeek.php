...
class SendAlertWeek extends Command
{
    ...
    {
        if (Carbon::now()->dayOfWeek == Carbon::THURSDAY /*MONDAY*/ ) {
            ...
            foreach ($alerta_fechas as $item) {
                ...
                //array_push($estructura_entregable, explode(",",$item->contrato->estructura_informe));
            }
            $details = [
                'title' => 'Notificación de entregables del ' . $from . ' al ' . $to,
                'alerta' => 1,
