...
class SendAlertEndContract30 extends Command
{
     ...
     * @var string
     */
    protected $signature = 'send:alertendcontract30';
     ...
     * @var string
     */
    protected $description = 'the alert is sent when a contract is one month (30 days) away from ending '; //se envia la alerta cuando un contrato esta a un mes de terminar
    ...
    public function handle()
    {
        ...
        $cc=['teamsoc@gruporadical.com','ana.rivera@gruporadical.com'];
             ...
             $alerta_fechas = Contrato::with('cliente')
                            ...
                            ->where('fecha_fin',Carbon::now()->addDays(30)->format('Y-m-d')) // fecha finalizacion es hoy + 30 dias
